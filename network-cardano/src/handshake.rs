    ...
    pub async fn handshake(&mut self) -> Result<(), Error> {
        match self {
            Self::N2N(n2n) => {
                ...
                n2n.write_one(handshake_n2n::Message::ProposeVersions(versions_proposal))
                    .await;
                let msg = n2n
                ...
                match msg {
                    handshake_n2n::ProposeVersionsRet::AcceptVersion(
                        version,
                        handshake_node_data,
                    ) => {
            ...
            Self::N2C(n2c) => {
                ...
                n2c.write_one(handshake_n2c::Message::ProposeVersions(versions_proposal))
                    .await;
                let msg = n2c
                ...
                match msg {
                    handshake_n2c::ProposeVersionsRet::AcceptVersion(
                        version,
                        handshake_node_data,
                    ) => {
                        tracing::debug!("accepted {:?} {:?}", version, handshake_node_data);
